...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-gradient-to-r from-primary to-violet-600 text-primary-foreground hover:from-primary/90 hover:to-violet-600/90 shadow-md hover:shadow-lg hover:-translate-y-0.5",
        destructive:
          "bg-gradient-to-r from-rose-500 to-orange-600 text-destructive-foreground hover:from-rose-500/90 hover:to-orange-600/90 shadow-md hover:shadow-lg hover:-translate-y-0.5",
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground hover:shadow-sm hover:-translate-y-0.5",
        secondary:
          "bg-gradient-to-r from-slate-100 to-slate-200 text-secondary-foreground hover:from-slate-200 hover:to-slate-300 shadow-sm hover:shadow-md hover:-translate-y-0.5",
